...
<p class="uk-text-muted uk-text-small"><?php echo t("disbaled popup instead use a page");?></p>
...
<div class="uk-form-row">
  ...
  <?php 
  echo CHtml::radioButton('admin_activated_menu',
  Yii::app()->functions->getOptionAdmin("admin_activated_menu",$merchant_id)=="1"?true:false
  ,array(
    'value'=>"1",
    'class'=>"icheck"
  ))
...
<div class="uk-form-row">
  ...
  <?php 
  echo CHtml::radioButton('admin_activated_menu',
  Yii::app()->functions->getOptionAdmin("admin_activated_menu",$merchant_id)=="2"?true:false
  ,array(
    'value'=>"2",
    'class'=>"icheck"
  ))
...
<div class="uk-form-row">
  ...
  <?php echo CHtml::dropDownList('admin_decimal_place',empty($admin_decimal_place)?2:$admin_decimal_place,Yii::app()->functions->decimalPlacesList()
  ,array(
  'class'=>'uk-form-width-large',
  'data-validation'=>"required"
  ))?>
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","Search as post code")?></label>
  <?php 
  echo CHtml::radioButton('home_search_mode',
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","post code search type")?></label>
  <?php 
